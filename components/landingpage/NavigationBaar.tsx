...
<h1 className='text-black  hidden md:block  font-bold '>{nameonly} .</h1>
    ...
    <Link href={'/signin'} target="_blank" className=
       ...
       '  text-center  text-sm  mr-2  tracking-tighter bg-yellow-500  flex items-center hover:bg-gray-600/80 hover:text-black duration-300 ease-in-out p-1.5  rounded-xl   w-fit    '
