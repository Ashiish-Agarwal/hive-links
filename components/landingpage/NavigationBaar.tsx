...
},
{
  ...
  return (
   <div className='grid  bg-white   grid-cols-3 gap-4 border-2 border-zinc-500/20 sticky top-0 z-50  h-10 md:h-15   backdrop-blur w-[90%] md:w-[60%]  mx-auto items-center rounded-md  justify-center  '>
    <div>
      <Sheet >
        <SheetTrigger>
...
<MenuIcon/>
    ...
    <Link href={'/'} target="_blank" className='flex gap-2 items-center justify-center '>
...
<h1 className='text-black  hidden md:block  font-bold '>{nameonly} .</h1>
    ...
    <Link href={'/signin'} target="_blank" className=
       ...
       '  text-center  text-sm  mr-2  tracking-tighter bg-yellow-500  flex items-center hover:bg-yellow-500/80 hover:text-black duration-300 ease-in-out p-1.5  rounded-md   w-fit    '
