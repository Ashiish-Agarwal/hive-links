    ...
    <div className='p-2 w-full   '>
         <div className='flex  items-center justify-center mt-10  '>
            <div className='bg-white rounded-lg  rounded-r-none'>
              <Input  className='w-[30vw]    h-16  rounded-r-none text-zinc-500 placeholder:text-zinc-500 text-sm  ' placeholder='enter the name' value={name} onChange={(e)=>setName(e.target.value) }/>
               </div>
            ...
            })} href={'/signin'} target="_blank" >create your link </Link>
            </div>
