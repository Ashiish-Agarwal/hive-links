    ...
    <Popover >
      <PopoverTrigger  >
        <span
          aria-label="Share"
                 >
          <Share  className=" bg-white rounded-full   p-1  hover:bg-gray-100 duration-300 ease-in-out" size={30} />
          ...
          <div className="grid grid-cols-3 gap-3">
            {shareLinks.map((platform) => (
              <a
                ...
                className={`flex flex-col items-center gap-2 p-3 rounded-lg border border-gray-200 transition-all ${platform.color}`}
              >
                {platform.icon}
