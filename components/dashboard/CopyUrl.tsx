    ...
    <div className="  w-full   ">
      <div className=" flex gap-5  items-center w-full h-full justify-center  ">
        ...
        <input
          ...
          value={`${CopyDomain}/box/${id}/${encodeURIComponent(name)}/inbox`}
          disabled
          readOnly
          />
          </div>
          ...
          <ClipboardWithIcon title="Copy" className="" valueToCopy= {`${CopyDomain}/box/${id}/${encodeURIComponent(name)}/inbox`} />
